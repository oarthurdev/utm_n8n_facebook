          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatusCard
              ...
              value={
                isLoadingStats
                  ? "Loading..."
                  : stats?.integrationStatus.status || "Unknown"
              }
              icon="check_circle"
              ...
              metaValue={
                isLoadingStats
                  ? "Loading..."
                  : stats?.integrationStatus.lastChecked || "Unknown"
              }
            />
            ...
            <StatusCard
              ...
              value={
                isLoadingStats ? "-" : stats?.leadsToday.count.toString() || "0"
              }
              icon="person_add"
            ...
            <StatusCard
              ...
              value={
                isLoadingStats
                  ? "-"
                  : stats?.eventsToday.total.toString() || "0"
              }
              icon="send"
            ...
            <StatusCard
              ...
              value={
                isLoadingStats ? "-" : `${stats?.utmData.percentage}%` || "0%"
              }
              icon="analytics"
              ...
              progressBar={{
                ...
                color: "bg-warning",
                label: isLoadingStats
                  ? "Loading..."
                  : `${stats?.utmData.raw || "0 of 0"} leads with UTM data`,
              }}
            />
          </div>
        </section>
